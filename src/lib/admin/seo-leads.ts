...
export const defaultAdminSeoLeads: AdminSeoLeadsStore = {
  ...
  routes: [
    ...
    {
      id: "sound-healing",
      label: "Sound Healing Retreat in Rishikesh",
      ...
      priority: 0.66,
      changeFrequency: "monthly",
      focusKeyword: "sound healing retreat in Rishikesh",
      qaStatus: "ready",
      notes: "Updated with sound healing retreat copy, sound bath comparison, FAQ and image-led SXO content.",
      lastReviewedAt: "2026-08-15",
    },
    {
      id: "panchkarma-detox",
      label: "Panchakarma Retreat in Rishikesh",
      ...
      priority: 0.66,
      changeFrequency: "monthly",
      focusKeyword: "panchakarma retreat in Rishikesh",
      qaStatus: "ready",
      notes: "Updated with Panchakarma/Panchkarma keyword coverage, comparison table, FAQs and image-led responsible detox boundaries.",
      lastReviewedAt: "2026-08-15",
    },
    {
      id: "chakra-opening",
      label: "Chakra Opening Retreat in Rishikesh",
      ...
      priority: 0.64,
      changeFrequency: "monthly",
      focusKeyword: "chakra opening retreat in Rishikesh",
      qaStatus: "ready",
      notes: "Updated with chakra opening keyword coverage, grounded comparison table, FAQ answers and image-led integration content.",
      lastReviewedAt: "2026-08-15",
    },
    {
      id: "spiritual-sadhanas",
      label: "Spiritual Sadhana Retreat in Rishikesh",
      ...
      priority: 0.66,
      changeFrequency: "monthly",
      focusKeyword: "spiritual sadhana retreat in Rishikesh",
      qaStatus: "ready",
      notes: "Updated with spiritual sadhana retreat keyword coverage, grounded comparison table, FAQ answers and image-led integration content.",
      lastReviewedAt: "2026-08-15",
    },
    {
      id: "testimonials",
