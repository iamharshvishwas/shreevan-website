    ...
    cards: [
      {
        ...
        tag: "Getting here",
        title: "Getting here",
        copy: "Airport transfers are arranged; e-Visa is straightforward for most nationalities.",
      },
      {
        id: "travel-2",
        tag: "Where you'll stay",
        title: "Where you'll stay",
        copy: "Private or shared rooms, simply furnished and comfortable, on the retreat grounds.",
      },
      {
        id: "travel-3",
        tag: "What you'll eat",
        title: "What you'll eat",
        copy: "Sattvic, plant-forward meals, seasonal and easy on travel-tired digestion.",
      },
      {
        id: "travel-4",
        tag: "What to pack",
        title: "What to pack",
        copy: "Modest, comfortable layers — days are active but low-impact, no prior fitness required.",
      },
    ],
  },
  location: {
